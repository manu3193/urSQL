 ...
 * BPlusTree.java Clase encargada de crear el árbol B+ que guarda la estructura
...
public class ArbolBMas implements Serializable{
    ...
    /**
     * Raiz es un atributo tipo BPlusTree.NodoArbol que representa la raíz del árbol.
     */
